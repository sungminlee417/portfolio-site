  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 text-center max-w-4xl mx-auto">
        ...
        >
          <span className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-yellow-400/30 to-orange-400/30 backdrop-blur-xl shadow-2xl relative animate-float">
            <Image
              src="/guitar-code.png"
        ...
        >
          <a
            ...
            className="px-8 py-3 bg-yellow-400 text-black font-semibold rounded-full hover:bg-yellow-300 transition-all duration-200 hover:scale-105 shadow-lg cursor-pointer"
          >
            Learn More
          </a>
          <a
            ...
            className="px-8 py-3 bg-white/10 backdrop-blur-md text-white font-semibold rounded-full hover:bg-white/20 transition-all duration-200 hover:scale-105 border border-white/20 cursor-pointer"
          >
            View Projects
          </a>
        </div>
