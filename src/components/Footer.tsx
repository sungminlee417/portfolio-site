      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center gap-8">
          <div className="flex gap-6">
            {socialLinks.map((link) => (
              <a
                ...
                className="group p-3 glass rounded-full hover:bg-white/20 transition-all duration-300 hover:scale-110"
                aria-label={link.name}
              >
                <span className="block text-gray-400 group-hover:text-white transition-colors duration-300">
                  {link.icon}
                </span>
              </a>
            ))}
          ...
          <a
            ...
            className="group flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer"
