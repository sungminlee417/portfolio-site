...
const projects = [
  {
    ...
    highlights: [
      ...
      "Supports sending images of foods to assist with AI recognition",
            ...
            <div key={project.name} className="card p-6">
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  {project.featured && (
                    <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[hsl(var(--primary))] text-white">
                      Featured
                    </span>
                  )}
                </div>
                <div className="flex gap-2">
                  {project.repo && (
                    <a href={project.repo} target="_blank" rel="noopener noreferrer" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors" aria-label="GitHub">
                  ...
                  {project.link && (
                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] transition-colors" aria-label="Live Demo">
              ...
              <p className="text-sm text-[hsl(var(--muted-foreground))] mb-4">{project.description}</p>
